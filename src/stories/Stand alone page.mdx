...
- [Development Resources](#development-resources)
  ...
  - [Go to button primary page](?path=/story/design-system-atoms-button--primary)
  - [Go to the conclusion of the documentation page to musi być inny plik przekierowało](?path=/docs/stories-stand-alone-page--docs#coding-standards)
